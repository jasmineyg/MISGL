...
"""Efficient paper runner: one dataset load serves all ten folds in a group."""
...
def run_group(group, gpu, args):
    ...
    command = [
        sys.executable,
        os.path.join(base.WORK, 'run_coarse_gcn_paper_allfolds.py'),
        '--hparam_path', group['config'],
        '--data_name', dataset['name'],
        '--processed_data_dir', dataset['data_dir'],
        '--device', 'cuda',
        '--out_dir', out_dir,
        '--all_folds',
